...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans antialiased min-h-screen flex flex-col transition-colors duration-200 relative">
    ...
    <div x-data="{ open: false }" class="fixed top-3 left-2 z-50">
        ...
        <div x-show="open" 
            ...
            @if($isAdmin)
                <a href="http://127.0.0.1:8000/franchises/switch-by-slug/{{ session('active_group_key', 'retd') }}" class="flex items-center gap-3 px-4 py-2 mx-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-[var(--brand-primary)] transition">
                    <svg class="w-5 h-5 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @if($canSeeIA)
                <a href="http://127.0.0.1:8000/franchises/switch-by-slug/{{ $currentGroupKey }}?redirect_to=/assistant" rel="noreferrer" class="flex items-center gap-3 px-4 py-2 mx-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-[var(--brand-primary)] transition">
